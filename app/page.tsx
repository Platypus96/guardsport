      ...
      <footer className="w-full border-t border-slate-800 bg-slate-950/50 relative z-10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm font-medium text-slate-400">
            ...
            <a href="https://www.linkedin.com/in/adarsh-kumar-bhardwaj-6a403a297/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-white transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
